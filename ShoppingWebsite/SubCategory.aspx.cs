...
namespace ShoppingWebsite
{
    public partial class SubCategory : System.Web.UI.Page
    {
        ...
        protected void btnAddSubCategory_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into tblSubCategory(SubCatName,MainCatID) Values('" + tbSubCategory.Text + "','" + ddlMainCatID.SelectedItem.Value + "')", con);
                cmd.ExecuteNonQuery();


                tbSubCategory.Text = string.Empty;
